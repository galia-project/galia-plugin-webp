...
public class WebPDecoderOptions {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        demux_h.C_INT.withName("bypass_filtering"),
        demux_h.C_INT.withName("no_fancy_upsampling"),
        demux_h.C_INT.withName("use_cropping"),
        demux_h.C_INT.withName("crop_left"),
        demux_h.C_INT.withName("crop_top"),
        demux_h.C_INT.withName("crop_width"),
        demux_h.C_INT.withName("crop_height"),
        demux_h.C_INT.withName("use_scaling"),
        demux_h.C_INT.withName("scaled_width"),
        demux_h.C_INT.withName("scaled_height"),
        demux_h.C_INT.withName("use_threads"),
        demux_h.C_INT.withName("dithering_strength"),
        demux_h.C_INT.withName("flip"),
        demux_h.C_INT.withName("alpha_dithering_strength"),
